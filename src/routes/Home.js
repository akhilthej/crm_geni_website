  ...
  return (
    <>
      ...
      <section className="pt-24 bg-white">
        ...
        <section>
          <div className="py-16 bg-secoundry">
            <div className="mx-auto px-6 max-w-6xl text-gray-500">
              <div className="text-center">
                <h2 className="text-3xl text-gray-950 font-semibold">
                  Seamlessly integrates with <br className="hidden sm:block" />{" "}
                  your favorite frontend tools
                </h2>
              ...
              <div className="mt-12 relative w-fit h-fit sm:mx-auto sm:px-0 -mx-6 px-6 overflow-x-auto">
                <div className="mb-3 flex w-fit mx-auto gap-3 text-gray-950 ">
                  <div className="border flex relative *:relative *:size-7 *:m-auto size-20 mx-auto rounded-xl   before:rounded-[11px] before:absolute before:inset-0 before:border-t before:border-white before:from-gray-100  before:bg-gradient-to-b   before:shadow ">
                    <svg
                      className="text-[#000014] "
